            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="planetName" className="text-purple-200">Time</Label>
                  <Input
                    id="planetName"
                    value={formData.planetName}
                    onChange={(e) => handleChange('planetName', e.target.value)}
                    placeholder="e.g., [0.0, 0.5, 1.0, 1.5, 2.0]"
                ...
                {/* FLUX - NUMBER ARRAY */}
                <div className="space-y-2">
                  <Label htmlFor="stellarMass" className="text-purple-200">Flux</Label>
                  <Input
                    id="stellarMass"
                    type="number"
                    step="0.01"
                    ...
                    placeholder="e.g., [1.000, 0.998, 0.995, 0.999, 1.002]"
                    className="glass-input text-white placeholder:text-purple-500/40"
                    required
                  />
                </div>
                ...
                {/* PERIOD -NUMBER ONE */}
                <div className="space-y-2">
                  <Label htmlFor="orbitalPeriod" className="text-purple-200">Period</Label>
                  <Input
                    id="orbitalPeriod"
                    type="number"
                    step="0.01"
                ...
                {/* T_0 - NUMBER ONE */}
                <div className="space-y-2">
                  <Label htmlFor="planetRadius" className="text-purple-200">T_0</Label>
                  <Input
                    id="planetRadius"
                    type="number"
                    step="0.01"
                    ...
                    placeholder="e.g., 2457000.123 (BJD)"
                    className="glass-input text-white placeholder:text-purple-500/40"
                    required
                  />
                </div>
